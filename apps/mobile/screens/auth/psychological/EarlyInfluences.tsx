...
const EarlyInfluences = ({ navigation, route }) => {
    ...
    const allAnswers = [
        "A lot of closeness and emotional warmth",
        "A sense of safety and reliability",
        "A strong emphasis on independence",
        "A strong focus on performance",
        "Frequent conflicts and insecurity",
        "Unpredictability or mood swings",
                ...
                <View className="px-5 mt-3">
                    ...
                    <View className="flex-row justify-between items-center">
                        ...
                        <View className="flex-row items-center">
                            <Text className="text-white text-base font-PoppinsMedium">01 </Text>
...
export default EarlyInfluences;