...
const TrapAnswers = ({ navigation, route }) => {
    ...
    const allAnswers = [
        "I fall in love too quicly",
        "I hold on too long",
        "I withdraw when things get instense",
        "I lose myself in the needs of others",
        "I try to fix the relationship",
        "I choose partners who confirm my pain",
        "I suppress my needs to keep the peace",
        "I avoid vulnerability",
        "I confuse drama with real connection",
    ];
    ...
    const handleNext = () => {
        navigation.navigate('TrapsPreparation', {
            nextScreen: 'SomeOtherScreen',
            isFinalStep: true // Add this flag
        });
    };
                ...
                <View className="px-5" style={{ marginTop: insets.top }}>
                    ...
                    <View className="flex-row justify-between items-center">
                        ...
                        <View className="flex-row items-center">
                            <Text className="text-white text-base font-PoppinsMedium">03 </Text>
                            ...
                            <View className="flex-col gap-2.5">
                                ...
                                <View className="flex-col gap-4">
                                    <Text className="text-white text-base font-PoppinsMedium leading-6">
                                        Which typical trap do you recognize in yourself?
                                    </Text>
                                </View>
